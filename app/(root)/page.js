  ...
  return (
    <div className="flex flex-row justify-center items-center w-full gap-4 h-full">
      <div className="flex flex-col gap-8">
        <motion.h1
          className="pb-6 text-[100px] leading-none font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-pink-500 to-purple-500"
        ...
        <motion.p
          className="text-base text-gray-800 font-semibold w-4/5 text-center md:text-start"
          initial={{ opacity: 0, x: 100 }}
          animate={{ opacity: 1, x: 0 }}
